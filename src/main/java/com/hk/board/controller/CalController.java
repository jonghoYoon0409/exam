...
public class CalController {
	...
	public String calendar(Model model,HttpServletRequest request, RedirectAttributes redirectAttributes) {
		logger.info("달력보기");
...
//		String month=request.getParameter("month");
		...
		/*
		 * //redirectAttributes에 값 추가 redirectAttributes.addAttribute("patientId",
		 * patientId);
		 */
	...
	public String calboardlist(Model model
		...
		String id=(String)session.getAttribute("patientid");//회원관리시 사용될 ID <-- 나중에는 세션에서 가져와야 함
